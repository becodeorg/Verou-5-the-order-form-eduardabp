...
<head>
    ...
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" type="text/css"
          rel="stylesheet"/>
    <title>Shop from the Future</title>
</head>
<body>
<div class="container">
    ...
    */ ?>
    <form method="POST">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="email" id="email" name="email" class="form-control" value="<?php echo filter_input(INPUT_POST, "email");?>"/>
            </div>
            <div></div>
        </div>
        ...
        <fieldset>
            ...
            <?php foreach ($products as $i => $product): ?>
                <label>
                    <input type="checkbox" value="<?php echo $i ?>" name="products[<?php echo $i ?>]" <?= in_array($i, $_POST['products'] ?? []) ? 'checked' : '' ?> /> <?php echo $product['name'] ?> -
    ...
    <footer>You already ordered <strong>&euro; <?php echo $totalValue ?></strong> in futuristic gadgets.</footer>
</div>
